...
want_instructions = yes_no("Do you want to see the instruction? ")
...
while comp_score < game_goal and user_score < game_goal:
    ...
    while player_1_points < 13 and player_2_points < 13:
        ...
        print(f"\033[95m {second}: Rolled a {player_2_roll} - has {player_2_points} points\033[0m")
        print(f"\033[95m {first}: {player_1_points}  | {second} {player_2_points}\033[0m")
    ...
    # work out who won and set the loser's point to zero...
    if user_points > comp_points:
        winner = "User"
        loser = "Computer"
        comp_points = 0
    ...
    # set up rounds feedback and display it...
    ...
    print("\033[95m *** Game Update ***\033[0m")     # replace with call to statement generator
    print(f"User Score: {user_score}  | Computer Score: {comp_score}")

# ends of entire game , output final results
